...
local function StartSpike(inst, duration, variation)
    ...
    inst.basefx = SpawnPrefab("sisturn_spike_base")
...
return Prefab("sisturn_spike", fn, assets, prefabs),
    Prefab("sisturn_spike_base", basefn, assets)
